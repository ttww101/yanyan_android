...
public class LoadMoreListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private static final String TAG = "[CCAAII]LoadMoreListView";
    ...
    private void init(Context context) {
        ...
        // footer
        mFooterView = (RelativeLayout) mInflater.inflate(R.layout.listview_load_footer, this, false);
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (isEnable) {
            if (mOnLoadMoreListener != null) {
                ...
                if (!mIsLoadingMore && loadMore && mCurrentScrollState != SCROLL_STATE_IDLE) { //判断如果滚动到底部，并且已经停止滚动的时候，我们就显示底部加载更多。
