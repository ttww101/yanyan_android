...
public class NetworkUtils {
    ...
    private static final String TAG = "[CCAAII]NetworkUtils";
    ...
    private static NetworkState isNetworkStateChanged(Context context, NetworkState state) {
        if (!state.equals(previousNetworkState)) {
            ...
            context.sendBroadcast(new Intent(CcaaiiConstants.ACTION_NETWORK_STATE_CHANGED));
        }
        return state;
    }
    ...
    public static boolean isAvailable(Context context) {
        ...
        try {
            ...
            if (LogLevel.MARKET) {
                MarketLog.i(TAG, "isAvailable():  NetworkState = " + network_state + "; return " + result);
            }
            return result;
        } catch (Exception e) {
            return false;
