...
/**
 */
public class CcaaiiAlertDialog extends Dialog{

    public CcaaiiAlertDialog(Context context) {
        super(context, R.style.CooldingAlertDialog);
    }
    ...
    public static class Builder {
        ...
        public CcaaiiAlertDialog create() {
            LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            final CcaaiiAlertDialog dialog = new CcaaiiAlertDialog(mContext);
            View layout = inflater.inflate(R.layout.coolding_alert_dialog_layout, null);
